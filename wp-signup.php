...
function show_blog_form($blogname = '', $blog_title = '', $errors = '')
{
    ...
    if (! empty($languages)) :
        ?>
		<p>
			<label for="site-language"><?php _e('Site Language:');
    ?></label>
			<?php
            // Network default.
...
function confirm_user_signup($user_name, $user_email)
{
    ...
    ?></p>
	<p><?php _e('If you do not activate your username within two days, you will have to sign up again.');
    ?></p>
	<?php
    /** This action is documented in wp-signup.php */
    do_action('signup_finished');
...
function validate_blog_signup()
{
    ...
    $public = (int) $_POST['blog_public'];
    $signup_meta = ['lang_id' => 1, 'public' => $public];
...
function confirm_blog_signup($domain, $path, $blog_title, $user_name = '', $user_email = '', $meta = [])
{
    ...
    printf(__('Check your inbox at %s and click the link given.'), '<strong>' . $user_email . '</strong>');
    ?></p>
	<p><?php _e('If you do not activate your site within two days, you will have to sign up again.');
    ?></p>
	<h2><?php _e('Still waiting for your email?');
    ?></h2>
	<p>
