...
function login_header($title = 'Log In', $message = '', $wp_error = '')
{
    ...
    ?>" />
	<title><?php echo get_bloginfo('name', 'display') . $separator . $title;
    ?></title>
	<?php
    ...
    if (!is_wp_error($user) && !$reauth) {
        if ($interim_login) {
			...
			<?php if ($customize_login) : ?>
				<script type="text/javascript">setTimeout( function(){ new wp.customize.Messenger({ url: '<?php echo wp_customize_url();
