...
function twentysixteen_custom_header_and_background()
{
     ...
     * }
     */
    add_theme_support('custom-background', apply_filters('twentysixteen_custom_background_args', [
     ...
     * }
     */
    add_theme_support('custom-header', apply_filters('twentysixteen_custom_header_args', [
...
{
    wp_enqueue_script('color-scheme-control', get_template_directory_uri() . '/js/color-scheme-control.js', [ 'customize-controls', 'iris', 'underscore', 'wp-util' ], '20160816', true);
...
{
    wp_enqueue_script('twentysixteen-customize-preview', get_template_directory_uri() . '/js/customize-preview.js', [ 'customize-preview' ], '20160816', true);
}
