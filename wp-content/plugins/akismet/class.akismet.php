...
class Akismet
{
    ...
    public static function http_post($request, $path, $ip = null)
    {
        ...
        if (! $ssl_disabled && function_exists('wp_http_supports') && ($ssl = wp_http_supports([ 'ssl' ]))) {
    ...
    public static function load_form_js()
    {
        ...
        wp_register_script('akismet-form', plugin_dir_url(__FILE__) . '_inc/form.js', [], AKISMET_VERSION, true);
...
<?php
    ...
    public static function pre_check_pingback($method)
    {
        ...
        if (!empty($args[1])) {
            ...
            add_filter('http_request_args', [ 'Akismet', 'pingback_forwarded_for' ], 10, 2);
