<div class="no-key config-wrap"><?php
    if ($akismet_user && in_array($akismet_user->status, [ 'active', 'active-dunning', 'no-sub', 'missing', 'cancelled', 'suspended' ])) :
        if (in_array($akismet_user->status, [ 'no-sub', 'missing' ])) :?>
...
<div class="activate-highlight secondary activate-option">
	...
	<?php Akismet::view('get', [ 'text' => __('Sign up with a different email address', 'akismet'), 'classes' => [ 'right', 'button', 'button-secondary' ] ]); ?>
</div>
<div class="activate-highlight secondary activate-option">
	<div class="option-description">
...
<div class="activate-highlight activate-option">
	...
	<?php Akismet::view('get', [ 'text' => __('Get your API key', 'akismet'), 'classes' => [ 'right', 'button', 'button-primary' ] ]); ?>
</div>
<div class="activate-highlight secondary activate-option">
	<div class="option-description">
