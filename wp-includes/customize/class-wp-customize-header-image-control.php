...
class WP_Customize_Header_Image_Control extends WP_Customize_Image_Control
{
    ...
    public function print_header_image_template()
    {
        ...
        ?>
			...
			<# if (data.type === 'uploaded') { #>
				<button type="button" class="dashicons dashicons-no close"><span class="screen-reader-text"><?php _e('Remove image');
        ?></span></button>
			<# } #>
			...
			<button type="button" class="choice thumbnail"
				...
				<span class="screen-reader-text"><?php _e('Set image');
        ?></span>
    ...
    public function render_content()
    {
        ...
        ?> class="button remove" aria-label="<?php esc_attr_e('Hide header image');
        ?>"><?php _e('Hide image');
        ?></button>
				<button type="button" class="button new" id="header_image-button"  aria-label="<?php esc_attr_e('Add new header image');
        ?>"><?php _e('Add new image');
        ?></button>
