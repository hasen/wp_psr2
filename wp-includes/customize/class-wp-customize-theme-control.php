...
class WP_Customize_Theme_Control extends WP_Customize_Control
{
    ...
    public function content_template()
    {
		...
		<# } #>
			...
			<# if ( data.theme.isActiveTheme ) { #>
				<span class="more-details" id="{{ data.theme.id }}-action"><?php _e('Customize');
        ?></span>
			<# } else { #>
				<span class="more-details" id="{{ data.theme.id }}-action"><?php _e('Live Preview');
        ?></span>
			<# } #>

			<div class="theme-author"><?php printf(__('By %s'), '{{ data.theme.author }}');
        ?></div>
        ...
        ?>
			...
			<# } else { #>
				...
				<div class="theme-actions">
					<button type="button" class="button theme-details"><?php _e('Theme Details');
        ?></button>
				</div>
			<# } #>
		</div>
