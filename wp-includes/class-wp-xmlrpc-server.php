...
class wp_xmlrpc_server extends IXR_Server
{
    ...
    {
        $defaults = [ 'post_status' => 'draft', 'post_type' => 'post', 'post_author' => 0,
    ...
    public function wp_getMediaLibrary($args)
    {
        ...
        $attachments = get_posts(['post_type' => 'attachment', 'post_parent' => $parent_id, 'offset' => $offset, 'numberposts' => $number, 'post_mime_type' => $mime_type ]);
