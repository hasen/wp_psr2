...
function wp_nav_menu($args = [])
{
    ...
    $defaults = [ 'menu' => '', 'container' => 'div', 'container_class' => '', 'container_id' => '', 'menu_class' => 'menu', 'menu_id' => '',
    ...
    foreach ((array) $menu_items as $key => $menu_item) {
        ...
        // if the menu item corresponds to the currently-requested URL
            ...
            if ($raw_item_url && in_array($item_url, [ $current_url, $_indexless_current, $_root_relative_current ])) {
                ...
                if (in_array(home_url(), [ untrailingslashit($current_url), untrailingslashit($_indexless_current) ])) {
