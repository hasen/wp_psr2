...
function get_blogs_of_user($user_id, $all = false)
{
    ...
    foreach ($keys as $key) {
        ...
        $blog_id = str_replace([ $wpdb->base_prefix, '_capabilities' ], '', $key);
...
function wp_dropdown_users($args = '')
{
    ...
    $query_args = wp_array_slice_assoc($r, [ 'blog_id', 'include', 'exclude', 'orderby', 'order', 'who' ]);
...
{
    $keys = [ 'first_name', 'last_name', 'nickname', 'description', 'rich_editing', 'comment_shortcuts', 'admin_color', 'use_ssl', 'show_admin_bar_front' ];
