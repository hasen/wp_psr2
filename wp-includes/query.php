...
class WP_Query
{
    ...
    public function fill_query_vars($array)
    {
        ...
        $array_keys = [ 'category__in', 'category__not_in', 'category__and', 'post__in', 'post__not_in', 'post_name__in',
    ...
    public function get_queried_object()
    {
        ...
        if ($this->is_category || $this->is_tag || $this->is_tax) {
            if ($this->is_category) {
                ...
                $tax_query_in_and = wp_list_filter($this->tax_query->queried_terms, [ 'operator' => 'NOT IN' ], 'NOT');
