...
function wpmu_update_blogs_date()
{
    ...
    update_blog_details($wpdb->blogid, ['last_updated' => current_time('mysql', true)]);
    /**
...
function update_blog_details($blog_id, $details = [])
{
    ...
    $update_details = [];
    $fields = [ 'site_id', 'domain', 'path', 'registered', 'last_updated', 'public', 'archived', 'mature', 'spam', 'deleted', 'lang_id'];
    ...
    $result = $wpdb->update($wpdb->blogs, $update_details, ['blog_id' => $blog_id]);
    ...
    if (function_exists('wp_cache_switch_to_blog')) {
        ...
        if (function_exists('wp_cache_add_global_groups')) {
            if (is_array($global_groups)) {
                ...
                wp_cache_add_global_groups([ 'users', 'userlogins', 'usermeta', 'user_meta', 'useremail', 'userslugs', 'site-transient', 'site-options', 'site-lookup', 'blog-lookup', 'blog-details', 'rss', 'global-posts', 'blog-id-cache', 'networks', 'sites', 'site-details' ]);
            }
...
function update_blog_status($blog_id, $pref, $value, $deprecated = null)
{
    ...
    if (! in_array($pref, [ 'site_id', 'domain', 'path', 'registered', 'last_updated', 'public', 'archived', 'mature', 'spam', 'deleted', 'lang_id'])) {
        return $value;
    }

    $result = $wpdb->update($wpdb->blogs, [$pref => $value, 'last_updated' => current_time('mysql', true)], ['blog_id' => $blog_id]);
