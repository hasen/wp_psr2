...
final class WP_Customize_Manager
{
    ...
    public function customize_preview_init()
    {
        ...
        add_action('wp_head', [ $this, 'customize_preview_html5' ]);
    ...
    public function register_controls()
    {
        ...
        $this->add_section(new WP_Customize_Themes_Section($this, 'themes', [
        ...
        $this->add_setting(new WP_Customize_Filter_Setting($this, 'active_theme', [
            'capability' => 'switch_themes',
        ]));
        ...
        if (! $this->is_theme_active()) {
            ...
            $this->add_control(new WP_Customize_Theme_Control($this, $active_theme['id'], [
                'theme'    => $active_theme,
                'section'  => 'themes',
        ...
        foreach ($themes as $theme) {
            ...
            $this->add_control(new WP_Customize_Theme_Control($this, $theme_id, [
                'theme'    => $theme,
                'section'  => 'themes',
                'settings' => 'active_theme',
            ]));
        ...
        $this->add_control(new WP_Customize_Site_Icon_Control($this, 'site_icon', [
            'label'       => __('Site Icon'),
            'description' => sprintf(
        ...
        $this->add_control(new WP_Customize_Cropped_Image_Control($this, 'custom_logo', [
            'label'         => __('Logo'),
            'section'       => 'title_tagline',
            'priority'      => 8,
        ...
        $this->add_control(new WP_Customize_Color_Control($this, 'header_textcolor', [
        ...
        $this->add_control(new WP_Customize_Color_Control($this, 'background_color', [
        ...
        $this->add_setting(new WP_Customize_Filter_Setting($this, 'header_image', [
            'default'        => get_theme_support('custom-header', 'default-image'),
            'theme_supports' => 'custom-header',
        ]));

        $this->add_setting(new WP_Customize_Header_Image_Setting($this, 'header_image_data', [
            // 'default'        => get_theme_support( 'custom-header', 'default-image' ),
            'theme_supports' => 'custom-header',
        ]));
        ...
        $this->add_setting(new WP_Customize_Background_Image_Setting($this, 'background_image_thumb', [
            'theme_supports' => 'custom-background',
        ]));
