...
class WP_oEmbed
{
     ...
     * @var array
     */
    private $compat_methods = [ '_fetch_with_format', '_parse_json', '_parse_xml', '_parse_body' ];
    ...
    public function __construct()
    {
        ...
        $providers = [
            '#http://((m|www)\.)?youtube\.com/watch.*#i'          => [ 'http://www.youtube.com/oembed',                             true  ],
            '#https://((m|www)\.)?youtube\.com/watch.*#i'         => [ 'http://www.youtube.com/oembed?scheme=https',                true  ],
            '#http://((m|www)\.)?youtube\.com/playlist.*#i'       => [ 'http://www.youtube.com/oembed',                             true  ],
            '#https://((m|www)\.)?youtube\.com/playlist.*#i'      => [ 'http://www.youtube.com/oembed?scheme=https',                true  ],
            ...
            '#https?://(www\.)?twitter\.com/.+?/status(es)?/.*#i' => [ 'https://publish.twitter.com/oembed',                        true  ],
            '#https?://(www\.)?twitter\.com/.+?/timelines/.*#i'   => [ 'https://publish.twitter.com/oembed',                        true  ],
            ...
            '#https?://videopress.com/v/.*#'                      => [ 'https://public-api.wordpress.com/oembed/1.0/?for=' . $host, true  ],
