...
function add_network_option($network_id, $option, $value)
{
    ...
    if (! is_multisite()) {
        ...
        $serialized_value = maybe_serialize($value);
        $result = $wpdb->insert($wpdb->sitemeta, [ 'site_id'    => $network_id, 'meta_key'   => $option, 'meta_value' => $serialized_value ]);
...
function delete_network_option($network_id, $option)
{
    ...
    if (! is_multisite()) {
        ...
        $result = $wpdb->delete($wpdb->sitemeta, [ 'meta_key' => $option, 'site_id' => $network_id ]);
    }
...
function update_network_option($network_id, $option, $value)
{
    ...
    if (! is_multisite()) {
        ...
        $serialized_value = maybe_serialize($value);
        $result = $wpdb->update($wpdb->sitemeta, [ 'meta_value' => $serialized_value ], [ 'site_id' => $network_id, 'meta_key' => $option ]);
