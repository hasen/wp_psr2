...
function wp_prepare_revisions_for_js($post, $selected_revision_id, $from = null)
{
    ...
    $revisions = wp_get_post_revisions($post->ID, [ 'order' => 'ASC', 'check_enabled' => false ]);
...
function wp_print_revision_templates()
{
	...
	<script id="tmpl-revisions-meta" type="text/html">
		<# if ( ! _.isUndefined( data.attributes ) ) { #>
			<div class="diff-title">
				<# if ( 'from' === data.type ) { #>
					<strong><?php _ex('From:', 'Followed by post revision info');
    ?></strong>
				<# } else if ( 'to' === data.type ) { #>
					<strong><?php _ex('To:', 'Followed by post revision info');
    ?></strong>
				<# } #>
	...
	<script id="tmpl-revisions-diff" type="text/html">
		...
		<div class="diff-error"><?php _e('Sorry, something went wrong. The requested comparison could not be loaded.');
    ?></div>
		<div class="diff">
