...
function wp_dashboard_right_now()
{
    ...
    if ($num_comm && ($num_comm->approved || $num_comm->moderated)) {
        ...
        ?>
		<li class="comment-count"><a href="edit-comments.php"><?php echo $text;
        ?></a></li>
		<?php
        ...
        ?>"><a href="edit-comments.php?comment_status=moderated" aria-label="<?php esc_attr_e($aria_label);
        ?>"><?php echo $text;
        ?></a></li>
		<?php
...
function wp_network_dashboard_right_now()
{
	...
	<p class="youhave"><?php echo $sentence;
    ?></p>
    ...
    ?>" method="get">
		<p>
			<label class="screen-reader-text" for="search-users"><?php _e('Search Users');
    ?></label>
			<input type="search" name="s" value="" size="30" autocomplete="off" id="search-users"/>
			<?php submit_button(__('Search Users'), 'button', false, false, [ 'id' => 'submit_users' ]);
    ?>
		</p>
	</form>
    ...
    ?>" method="get">
		<p>
			<label class="screen-reader-text" for="search-sites"><?php _e('Search Sites');
    ?></label>
			<input type="search" name="s" value="" size="30" autocomplete="off" id="search-sites"/>
			<?php submit_button(__('Search Sites'), 'button', false, false, [ 'id' => 'submit_sites' ]);
    ?>
		</p>
	</form>
<?php
...
function wp_dashboard_quick_press($error_msg = false)
{
	...
	<form name="post" action="<?php echo esc_url(admin_url('post.php'));
    ?>" method="post" id="quick-press" class="initial-form hide-if-no-js">

		<?php if ($error_msg) : ?>
		<div class="error"><?php echo $error_msg;
    ?></div>
		<?php endif;
    ?>
    ...
    ?>
		...
		<div class="textarea-wrap" id="description-wrap">
			<label class="screen-reader-text prompt" for="content" id="content-prompt-text"><?php _e('What&#8217;s on your mind?');
    ?></label>
...
function _wp_dashboard_recent_comments_row(&$comment, $show_date = true)
{
    ...
    ?>" <?php comment_class([ 'comment-item', wp_get_comment_status($comment) ], $comment);
    ?>>
    ...
    ?>
			...
			<p class="comment-author"><?php comment_author_link($comment);
    ?></p>

			<?php endif; // comment_type ?>
			<blockquote><p><?php comment_excerpt($comment);
    ?></p></blockquote>
...
function wp_dashboard_quota()
{
    ...
    ?>
	<h3 class="mu-storage"><?php _e('Storage Space');
    ?></h3>
...
function wp_welcome_panel()
{
    ...
    ?>"><?php _e('Customize Your Site');
    ?></a>
		<?php if (current_user_can('install_themes') || (current_user_can('switch_themes') && count(wp_get_themes([ 'allowed' => true ])) > 1)) : ?>
			<p class="hide-if-no-customize"><?php printf(__('or, <a href="%s">change your theme completely</a>'), admin_url('themes.php'));
    ?></p>
		<?php endif;
    ?>
	</div>
	<div class="welcome-panel-column">
		<h3><?php _e('Next Steps');
    ?></h3>
		<ul>
    ...
    ?></li>
		<?php endif;
    ?>
			<li><?php printf('<a href="%s" class="welcome-icon welcome-learn-more">' . __('Learn more about getting started') . '</a>', __('https://codex.wordpress.org/First_Steps_With_WordPress'));
    ?></li>
		</ul>
	</div>
	</div>
