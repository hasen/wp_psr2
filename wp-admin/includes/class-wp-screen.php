...
final class WP_Screen
{
    ...
    public function render_screen_meta()
    {
        ...
        ?>" tabindex="-1" aria-label="<?php esc_attr_e('Contextual Help Tab');
        ?>">
		...
		<?php if ($this->get_help_tabs()) : ?>
			...
			<button type="button" id="contextual-help-link" class="button show-settings" aria-controls="contextual-help-wrap" aria-expanded="false"><?php _e('Help');
        ?></button>
			</div>
		<?php endif;
        if ($this->show_screen_options()) : ?>
			<div id="screen-options-link-wrap" class="hide-if-no-js screen-meta-toggle">
			<button type="button" id="show-settings-link" class="button show-settings" aria-controls="screen-options-wrap" aria-expanded="false"><?php _e('Screen Options');
        ?></button>
			</div>
		<?php endif;
        ?>
    ...
    public function render_screen_layout()
    {
		...
		<legend class="screen-layout"><?php _e('Layout');
        ?></legend><?php
            for ($i = 1; $i <= $num; ++$i):
                ?>
