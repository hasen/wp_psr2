...
<?php
    ...
    public function display_rows()
    {
		...
		<div class="plugin-card plugin-card-<?php echo sanitize_html_class($plugin['slug']);
            ...
            ?></p>
					<p class="authors"><?php echo $author;
            ?></p>
				</div>
			</div>
            ...
            ?>
					<span class="num-ratings" aria-hidden="true">(<?php echo number_format_i18n($plugin['num_ratings']);
            ?>)</span>
				</div>
				<div class="column-updated">
					<strong><?php _e('Last Updated:');
            ?></strong> <?php printf(__('%s ago'), human_time_diff($last_updated_timestamp));
            ?>
				</div>
