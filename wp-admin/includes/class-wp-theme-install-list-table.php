...
class WP_Theme_Install_List_Table extends WP_Themes_List_Table
{
    ...
    public function single_row($theme)
    {
		...
		<h3><?php echo $name;
        ?></h3>
		<div class="theme-author"><?php printf(__('By %s'), $author);
        ?></div>
    ...
    public function theme_installer()
    {
		...
		<div id="theme-installer" class="wp-full-overlay expanded">
			<div class="wp-full-overlay-sidebar">
				<div class="wp-full-overlay-header">
					<a href="#" class="close-full-overlay button-secondary"><?php _e('Close');
        ?></a>
        ...
        ?>">
						...
						<span class="collapse-sidebar-label"><?php _e('Collapse');
        ?></span>
					</button>
				</div>
			</div>
    ...
    public function theme_installer_single($theme)
    {
        ...
        ?>
			...
			<div class="wp-full-overlay-main">
				<iframe src="<?php echo esc_url($theme->preview_url);
        ?>"></iframe>
			</div>
		</div>
		<?php
    ...
    public function install_theme_info($theme)
    {
        ...
        ?>
			<h3 class="theme-name"><?php echo $name;
        ?></h3>
			<span class="theme-by"><?php printf(__('By %s'), $author);
        ?></span>
        ...
        ?>
			<div class="theme-details">
				<?php wp_star_rating([ 'rating' => $theme->rating, 'type' => 'percent', 'number' => $theme->num_ratings ]);
        ?>
