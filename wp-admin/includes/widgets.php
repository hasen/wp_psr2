...
function wp_list_widgets()
{
    ...
    foreach ($sort as $widget) {
        ...
        $args = [ 'widget_id' => $widget['id'], 'widget_name' => $widget['name'], '_display' => 'template' ];
...
function wp_list_widget_controls($sidebar, $sidebar_name = '')
{
    ...
    if ($sidebar_name) {
		...
		<div class="sidebar-name">
			...
			<h2><?php echo esc_html($sidebar_name);
...
function wp_widget_control($sidebar_args)
{
    ...
    ?>">
			<span class="edit"><?php _ex('Edit', 'widget');
    ?></span>
			<span class="add"><?php _ex('Add', 'widget');
    ?></span>
			<span class="screen-reader-text"><?php echo $widget_title;
    ?></span>
		</a>
	</div>
	<div class="widget-title"><h3><?php echo $widget_title;
    ...
    ?></a> |
		<a class="widget-control-close" href="#close"><?php _e('Close');
    ?></a>
		</div>
    ...
    ?>">
			<?php submit_button(__('Save'), 'button-primary widget-control-save right', 'savewidget', false, [ 'id' => 'widget-' . esc_attr($id_format) . '-savewidget' ]);
    ?>
