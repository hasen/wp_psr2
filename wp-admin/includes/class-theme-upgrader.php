...
class Theme_Upgrader extends WP_Upgrader
{
    ...
    public function check_parent_theme_filter($install_result, $hook_extra, $child_result)
    {
        ...
        $api = themes_api('theme_information', ['slug' => $theme_info->get('Template'), 'fields' => ['sections' => false, 'tags' => false] ]); //Save on a bit of bandwidth.
    ...
    public function check_package($source)
    {
        ...
        $info = get_file_data($working_directory . 'style.css', [ 'Name' => 'Theme Name', 'Template' => 'Template' ]);
