...
$theme_field_defaults = [ 'description' => true, 'sections' => false, 'tested' => true, 'requires' => true,
...
<form id="search-themes" method="get">
	...
	<option value="term" <?php selected('term', $type) ?>><?php _e('Keyword');
    ?></option>
	<option value="author" <?php selected('author', $type) ?>><?php _e('Author');
    ?></option>
	<option value="tag" <?php selected('tag', $type) ?>><?php _ex('Tag', 'Theme Installer');
    ?></option>
	</select>
...
<p class="install-help"><?php _e('Find a theme based on specific features.');
    ?></p>
...
<li>
	<input type="checkbox" name="features[]" id="feature-id-<?php echo $feature;
            ...
            ?>" />
	<label for="feature-id-<?php echo $feature;
...
{
    ?>
<p class="install-help"><?php _e('If you have a theme in a .zip format, you may install it by uploading it here.');
    ?></p>
<form method="post" enctype="multipart/form-data" class="wp-upload-form" action="<?php echo self_admin_url('update.php?action=upload-theme');
    ?>">
	<?php wp_nonce_field('theme-upload');
    ?>
	<label class="screen-reader-text" for="themezip"><?php _e('Theme zip file');
    ?></label>
