...
function edit_user($user_id = 0)
{
    ...
    if (($update || ! empty($pass1)) && $pass1 != $pass2) {
        $errors->add('pass', __('<strong>ERROR</strong>: Please enter the same password in both password fields.'), [ 'form-field' => 'pass1' ]);
    }
...
function use_ssl_preference($user)
{
	...
	<tr class="user-use-ssl-wrap">
		...
		<td><label for="use_ssl"><input name="use_ssl" type="checkbox" id="use_ssl" value="1" <?php checked('1', $user->use_ssl);
