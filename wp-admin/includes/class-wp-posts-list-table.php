...
<?php
    ...
    {
        return [ 'widefat', 'fixed', 'striped', is_post_type_hierarchical($this->screen->post_type) ? 'pages' : 'posts' ];
    }
    ...
    public function get_columns()
    {
        ...
        if (post_type_supports($post_type, 'comments') && !in_array($post_status, [ 'pending', 'draft', 'future' ])) {
    ...
    public function column_cb($post)
    {
        ...
        ?></label>
			<input id="cb-select-<?php the_ID();
        ?>" type="checkbox" name="post[]" value="<?php the_ID();
        ?>" />
	...
	<form method="get"><table style="display: none"><tbody id="inlineedit">
		...
		<tr id="<?php echo $bulk ? 'bulk-edit' : 'inline-edit';
            ...
            ?>" style="display: none"><td colspan="<?php echo $this->get_column_count();
            ?>" class="colspanchange">

		<fieldset class="inline-edit-col-left">
			<legend class="inline-edit-legend"><?php echo $bulk ? __('Bulk Edit') : __('Quick Edit');
            ?></legend>
	...
	<?php if (!$bulk) : ?>
			...
			<legend><span class="title"><?php _e('Date');
            ?></span></legend>
    ...
    ?>
			...
			<div class="inline-edit-group wp-clearfix">
				<label class="alignleft">
					<span class="title"><?php _e('Password');
            ?></span>
            ...
            ?>
				...
				<label class="alignleft inline-edit-private">
					...
					<span class="checkbox-title"><?php _e('Private');
            ?></span>
				</label>
			</div>
	...
	<?php foreach ($hierarchical_taxonomies as $taxonomy) : ?>
			...
			<input type="hidden" name="<?php echo ($taxonomy->name === 'category') ? 'post_category[]' : 'tax_input[' . esc_attr($taxonomy->name) . '][]';
            ?>" value="0" />
	...
	<?php
        ...
        ?>
			<label>
				<span class="title"><?php _e('Parent');
            ?></span>
	<?php
        $dropdown_args = [
    ...
    ?>
			...
			<label>
				<span class="title"><?php _e('Template');
            ?></span>
				<select name="page_template">
	<?php	if ($bulk) : ?>
					<option value="-1"><?php _e('&mdash; No Change &mdash;');
            ?></option>
	<?php	endif; // $bulk ?>
    				<?php
	...
	<?php if (post_type_supports($screen->post_type, 'comments') || post_type_supports($screen->post_type, 'trackbacks')) :
		...
		<?php if (post_type_supports($screen->post_type, 'comments')) : ?>
			<label class="alignleft">
				<span class="title"><?php _e('Comments');
            ?></span>
				<select name="comment_status">
					<option value=""><?php _e('&mdash; No Change &mdash;');
            ?></option>
					<option value="open"><?php _e('Allow');
            ?></option>
					<option value="closed"><?php _e('Do not allow');
            ?></option>
				</select>
			</label>
		<?php endif;
	...
	<?php else : // $bulk ?>
            ...
            if (post_type_supports($screen->post_type, 'trackbacks')) : ?>
				<label class="alignleft">
					...
					<span class="checkbox-title"><?php _e('Allow Pings');
            ?></span>
				</label>
			<?php endif;
            ?>
	...
	<?php endif; // $bulk
			...
			<div class="inline-edit-group wp-clearfix">
				<label class="inline-edit-status alignleft">
					<span class="title"><?php _e('Status');
            ?></span>
					<select name="_status">
	<?php if ($bulk) : ?>
						<option value="-1"><?php _e('&mdash; No Change &mdash;');
	...
	<?php endif; // $bulk ?>
            ...
            ?></option>
						<option value="future"><?php _e('Scheduled');
            ?></option>
	<?php if ($bulk) : ?>
	...
	<?php endif; // $bulk ?>
					<?php endif;
            ?>
						<option value="pending"><?php _e('Pending Review');
            ?></option>
						<option value="draft"><?php _e('Draft');
            ?></option>
					</select>
				</label>
	...
	<?php	if ($bulk) : ?>
				...
				<label class="alignright">
					<span class="title"><?php _e('Sticky');
            ?></span>
					<select name="sticky">
						<option value="-1"><?php _e('&mdash; No Change &mdash;');
            ?></option>
						<option value="sticky"><?php _e('Sticky');
            ?></option>
    ...
    if ($bulk && current_theme_supports('post-formats') && post_type_supports($screen->post_type, 'post-formats')) {
        ...
        ?>
		<label class="alignleft">
		<span class="title"><?php _ex('Format', 'post format');
        ?></span>
		<select name="post_format">
			<option value="-1"><?php _e('&mdash; No Change &mdash;');
        ?></option>
			<option value="0"><?php echo get_post_format_string('standard');
        ?></option>
			<?php
	...
	<?php
		...
		<p class="submit inline-edit-save">
			<button type="button" class="button-secondary cancel alignleft"><?php _e('Cancel');
            ?></button>
			<?php if (! $bulk) {
    wp_nonce_field('inlineeditnonce', '_inline_edit', false);
    ?>
				<button type="button" class="button-primary save alignright"><?php _e('Update');
    ?></button>
