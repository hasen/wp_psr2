...
function wp_create_category($cat_name, $parent = 0)
{
    ...
    return wp_insert_category(['cat_name' => $cat_name, 'category_parent' => $parent]);
}
...
{
    $cat_defaults = [ 'cat_ID' => 0, 'taxonomy' => 'category', 'cat_name' => '', 'category_description' => '', 'category_nicename' => '', 'category_parent' => '' ];
