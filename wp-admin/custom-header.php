...
class Custom_Image_Header
{
    ...
    {
        $page = add_theme_page(__('Header'), __('Header'), 'edit_theme_options', 'custom-header', [ $this, 'admin_page' ]);
        if (! $page) {
            return;
        }
...
<p><?php printf(__('Header updated. <a href="%s">Visit your site</a> to see how it looks.'), home_url('/'));
    ?></p>
</div>
<?php 
}
...
<td>
	...
	<div id="headimg" style="<?php echo $header_image_style;
        ...
        ?>" tabindex="-1"><?php bloginfo('name');
        ?></a></h1>
		<div id="desc" class="displaying-header-text" <?php echo $style;
...
<td>
	...
	<p>
        ...
        ?>"
			data-update="<?php esc_attr_e('Set as header');
        ?>"><?php _e('Choose Image');
        ?></button>
	</p>
	</form>
...
<tr>
<th scope="row"><?php _e('Uploaded Images');
        ?></th>
<td>
	...
	<?php endif;
        if (! empty($this->default_headers)) : ?>
<tr>
<th scope="row"><?php _e('Default Images');
        ?></th>
<td>
...
<tr>
<th scope="row"><?php _e('Reset Image');
        ?></th>
<td>
...
<h3><?php _e('Header Text');
        ?></h3>

<table class="form-table">
<tbody>
<tr>
<th scope="row"><?php _e('Header Text');
        ?></th>
<td>
	<p>
	<label><input type="checkbox" name="display-header-text" id="display-header-text"<?php checked(display_header_text());
        ?> /> <?php _e('Show header text with your image.');
        ?></label>
	</p>
</td>
</tr>
...
<div class="wrap">
<h1><?php _e('Crop Header Image');
        ?></h1>

<form method="post" action="<?php echo esc_url(add_query_arg('step', 3));
        ?>">
	<p class="hide-if-no-js"><?php _e('Choose the part of the image you want to use as your header.');
        ?></p>
	<p class="hide-if-js"><strong><?php _e('You need JavaScript to choose a part of the image.');
        ?></strong></p>
