...
<div class="wrap">
    ...
    echo ' nav-tab-active';
		...
		<?php if ($num_locations && $menu_count) : ?>
			<a href="<?php echo esc_url(add_query_arg([ 'action' => 'locations' ], admin_url('nav-menus.php'))); ?>" class="nav-tab<?php if ($locations_screen) {
    echo ' nav-tab-active';
    ...
    ?>
					<tr class="menu-locations-row">
						<td class="menu-location-title"><label for="locations-<?php echo $_location;
    ?>"><?php echo $_name;
    ?></label></td>
    ...
    ?>">
								<option value="0"><?php printf('&mdash; %s &mdash;', esc_html__('Select a Menu'));
    ?></option>
    ...
    ?>
							...
							<div class="locations-row-links">
								...
								<span class="locations-edit-menu-link">
									<a href="<?php echo esc_url(add_query_arg([ 'action' => 'edit', 'menu' => $menu_locations[$_location] ], admin_url('nav-menus.php')));
    ?>">
										<span aria-hidden="true"><?php _ex('Edit', 'menu');
    ?></span><span class="screen-reader-text"><?php _e('Edit selected menu');
    ?></span>
									</a>
								</span>
								<?php endif;
    ?>
								<span class="locations-add-menu-link">
									<a href="<?php echo esc_url(add_query_arg([ 'action' => 'edit', 'menu' => 0, 'use-location' => $_location ], admin_url('nav-menus.php')));
    ?>">
	...
	<div class="manage-menus">
		...
		<span class="add-edit-menu-action">
			<?php printf(__('Edit your menu below, or <a href="%s">create a new menu</a>.'), esc_url(add_query_arg([ 'action' => 'edit', 'menu' => 0 ], admin_url('nav-menus.php')))); ?>
		...
		<?php else : ?>
			...
			<span class="add-new-menu-action">
				<?php printf(__('or <a href="%s">create a new menu</a>.'), esc_url(add_query_arg([ 'action' => 'edit', 'menu' => 0 ], admin_url('nav-menus.php')))); ?>
					...
					<div id="nav-menu-header">
						<div class="major-publishing-actions wp-clearfix">
							...
							<div class="publishing-action">
								<?php submit_button(empty($nav_menu_selected_id) ? __('Create Menu') : __('Save Menu'), 'button-primary menu-save', 'save_menu', false, [ 'id' => 'save_menu_header' ]); ?>
					...
					<div id="nav-menu-footer">
						<div class="major-publishing-actions wp-clearfix">
							...
							<span class="delete-action">
								<a class="submitdelete deletion menu-delete" href="<?php echo esc_url(wp_nonce_url(add_query_arg([ 'action' => 'delete', 'menu' => $nav_menu_selected_id ], admin_url('nav-menus.php')), 'delete-nav_menu-' . $nav_menu_selected_id)); ?>"><?php _e('Delete Menu'); ?></a>
							</span><!-- END .delete-action -->
							<?php endif; ?>
							<div class="publishing-action">
								<?php submit_button(empty($nav_menu_selected_id) ? __('Create Menu') : __('Save Menu'), 'button-primary menu-save', 'save_menu', false, [ 'id' => 'save_menu_footer' ]); ?>
							</div><!-- END .publishing-action -->
						</div><!-- END .major-publishing-actions -->
					</div><!-- /#nav-menu-footer -->
				</div><!-- /.menu-edit -->
