...
if (isset($_GET['editwidget']) && $_GET['editwidget']) {
    ...
    ?>>
	<h2><?php printf(__('Widget %s'), $name);
    ?></h2>
...
<?php if (isset($_GET['message']) && isset($messages[$_GET['message']])) {
    ?>
<div id="message" class="updated notice is-dismissible"><p><?php echo $messages[$_GET['message']];
    ?></p></div>
<?php 
} ?>
<?php if (isset($_GET['error']) && isset($errors[$_GET['error']])) {
    ?>
<div id="message" class="error"><p><?php echo $errors[$_GET['error']];
    ?></p></div>
<?php 
} ?>
...
foreach ($wp_registered_sidebars as $sidebar => $registered_sidebar) {
    ...
    ?>
        ...
        ?>
			...
			<?php if ($is_inactive_widgets) {
    ?>
			<p class="description"><?php _e('This will clear all items from the inactive widgets list. You will not be able to restore any customizations.');
    ?></p>
			<?php 
}
        ?>
